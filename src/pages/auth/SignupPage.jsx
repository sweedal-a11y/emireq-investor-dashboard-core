...
export default function SignupPage() {
  ...
  return (
    <div className="signup-page">
      ...
      <div className="signup-left" style={{ backgroundImage: `url(${backgroundImg})` }}>
        <div className="signup-left-header">
          <img src={emireqLogo} alt="Emireq" className="signup-logo" />
        ...
        <div className="signup-left-content">
          ...
          <h1 className="signup-left-title">Get Access to Your Investor Profile and Unlock Exclusive Deals.</h1>
        </div>
      </div>
      ...
      <div className="signup-right">
        <div className="signup-form-container">
          <div className="signup-form-header">
            <img src={emireqLogo} alt="Emireq" className="signup-form-logo" />
          </div>

          <div className="signup-form-content">
            <h2 className="signup-form-title">Create your account</h2>
            <p className="signup-form-subtitle">
              Start your investment journey with Emireq
            </p>
            ...
            <form onSubmit={handleSignup} className="signup-form">
              <div className="signup-form-group">
                ...
                <input
                  ...
                  className={`signup-form-input ${touched.username && errors.username ? 'signup-form-input--error' : ''}`}
                  placeholder="username"
                />
                {touched.username && errors.username && (
                  <span className="signup-form-error">{errors.username}</span>
                )}
              </div>
              ...
              <div className="signup-form-group">
                ...
                <input
                  ...
                  className={`signup-form-input ${touched.email && errors.email ? 'signup-form-input--error' : ''}`}
                  placeholder="example@gmail.com"
                />
                {touched.email && errors.email && (
                  <span className="signup-form-error">{errors.email}</span>
                )}
              </div>
              ...
              <div className="signup-form-group">
                ...
                <div className="signup-password-wrapper">
                  <input
                    ...
                    className={`signup-form-input ${touched.password && errors.password ? 'signup-form-input--error' : ''}`}
                    placeholder="************"
                  />
                  <button
                    type="button"
                ...
                {touched.password && errors.password && (
                  <span className="signup-form-error">{errors.password}</span>
                )}
              </div>
              ...
              <div className="signup-form-group">
                ...
                <div className="signup-password-wrapper">
                  <input
                    ...
                    className={`signup-form-input ${touched.confirmPassword && errors.confirmPassword ? 'signup-form-input--error' : ''}`}
                    placeholder="************"
                  />
                  <button
                    type="button"
                ...
                {touched.confirmPassword && errors.confirmPassword && (
                  <span className="signup-form-error">{errors.confirmPassword}</span>
                )}
              </div>
